...
#define HAVE_BOOLEAN /* to discourage redfinition of boolean in jmorecfg.h */
//#define NEED_SHORT_EXTERNAL_NAMES /* helps*/
extern "C"
{
...
void loop() {
  ...
  jpeg_mem_src(&cinfo, fb->buf, fb->len);
  ...
  uint8_t *pixel_data = (uint8_t*) malloc(row_stride * height);
  while (cinfo.output_scanline < height) {
    uint8_t *row_pointer = &pixel_data[cinfo.output_scanline * row_stride];
